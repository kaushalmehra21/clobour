                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('trial_days') is-invalid @enderror" 
                                        name="trial_days" value="{{ old('trial_days', 14) }}" required>
                                    @error('trial_days')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('max_units') is-invalid @enderror" 
                                        name="max_units" value="{{ old('max_units', 100) }}" required>
                                    @error('max_units')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('max_residents') is-invalid @enderror" 
                                        name="max_residents" value="{{ old('max_residents', 500) }}" required>
                                    @error('max_residents')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('max_staff') is-invalid @enderror" 
                                        name="max_staff" value="{{ old('max_staff', 10) }}" required>
                                    @error('max_staff')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
