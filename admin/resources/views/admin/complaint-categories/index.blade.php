        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Complaint Categories</li>
                </ol>
            </div>
            <div class="col-lg-6 text-end">
                <a href="{{ panel_route('complaint-categories.create') }}" class="btn btn-primary">
                        ...
                        <tr>
                            ...
                            <td class="text-end table-action-cell">
                                <div class="table-actions">
                                    <a href="{{ panel_route('complaint-categories.edit', $category) }}" class="btn btn-sm btn-outline-secondary"
                                        title="Edit {{ $category->name }}">
                                        <i data-feather="edit"></i>
                                        <span>Edit</span>
                                    </a>
                                    <form action="{{ panel_route('complaint-categories.destroy', $category) }}" method="POST" class="mb-0"
