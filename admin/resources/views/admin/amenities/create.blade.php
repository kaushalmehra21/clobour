...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ panel_route('amenities.store') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" name="booking_fee" class="form-control @error('booking_fee') is-invalid @enderror" 
                                value="{{ old('booking_fee', 0) }}" required>
                            @error('booking_fee')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" name="max_advance_booking_days" class="form-control @error('max_advance_booking_days') is-invalid @enderror" 
                                value="{{ old('max_advance_booking_days', 30) }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" name="min_advance_booking_hours" class="form-control @error('min_advance_booking_hours') is-invalid @enderror" 
                                value="{{ old('min_advance_booking_hours', 2) }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" name="max_booking_duration_hours" class="form-control" value="{{ old('max_booking_duration_hours') }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="requires_approval" id="requires_approval" {{ old('requires_approval') ? 'checked' : '' }}>
