...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ panel_route('expenses.update', $expense) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            @if($expense->receipt_file)
                                <small class="text-muted">Current: <a href="{{ Storage::url($expense->receipt_file) }}" target="_blank">View Receipt</a></small>
                            @endif
                        </div>
                    </div>
                    <div class="col-md-6">
