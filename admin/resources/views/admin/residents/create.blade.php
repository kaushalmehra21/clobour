...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ panel_route('residents.store') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="type" class="form-control @error('type') is-invalid @enderror" required>
                                ...
                                <option value="family_member" {{ old('type') == 'family_member' ? 'selected' : '' }}>Family Member</option>
                            </select>
                            @error('type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="date" name="move_in_date" class="form-control" value="{{ old('move_in_date') }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
