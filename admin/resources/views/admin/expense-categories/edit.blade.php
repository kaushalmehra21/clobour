...
<div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ panel_route('expense-categories.index') }}">Categories</a></li>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ panel_route('expense-categories.update', $expenseCategory) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="text-end">
                    <a href="{{ panel_route('expense-categories.index') }}" class="btn btn-secondary">Cancel</a>
